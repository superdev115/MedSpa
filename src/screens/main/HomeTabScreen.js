        ...
        return (
            <SafeAreaView style={styles.container} >
                    ...
                    <View style={styles.selectDatePanel}>
                        <View style={styles.selectDateArrowContainer}>
                            <TouchableOpacity onPress={() => this.changeDate(-1)}>
                                <Icon name='chevron-left' iconStyle={styles.selectDateArrowStyle} color='thistle' />
                            </TouchableOpacity>
                        </View>
                        ...
                        <View style={styles.selectDateArrowContainer}>
                            <TouchableOpacity onPress={() => this.changeDate(1)}>
                                <Icon name='chevron-right' iconStyle={styles.selectDateArrowStyle} color='thistle' />
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
                ...
                <TouchableOpacity style={styles.takePhotoButton} onPress={() => {onTakePhoto()}}>
                    <Icon raised name='add-a-photo' style={{}} color='white' backgroundColor='dodgerblue' />
                </TouchableOpacity>
                <TouchableOpacity style={styles.addNewButton} onPress={() => {onAddNew(this.state.currentDate, this.state.selectedIndex)}}>
                    <Icon raised name='note-add' style={{}} color='white' backgroundColor='darkorange' />
                </TouchableOpacity>
            </SafeAreaView>
        )
    }
